                    ...
                    <form action="{{ route('admin.footer-grid-two.update', $footerGridTwo->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select name="language" id="language-select" class="form-control">
                                ...
                                @foreach ($languages as $lang)
                                    <option {{ $lang->lang === $footerGridTwo->language ? 'selected' : '' }}
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" id="" class="form-control">
                                ...
                                <option {{ $footerGridTwo->status === 0 ? 'selected' : '' }} value="0">Inactive
                                </option>
                            </select>
                            @error('status')
                                <p class="text-danger">{{ $message }}</p>
