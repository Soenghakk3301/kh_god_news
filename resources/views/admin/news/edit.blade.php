            ...
            <div class="card-body">
                <form action="{{ route('admin.news.update', $news->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input name="tags" type="text" class="form-control col-12" id="inputtags"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label class="custom-switch mt-2">
                                    <input {{ $news->status === 1 ? 'checked' : '' }} type="checkbox" value="1"
                                        name="status" data-id="{{ $news->id }}" data-name="status"
                            ...
                            <div class="form-group">
                                ...
                                <label class="custom-switch mt-2">
                                    <input {{ $news->is_breaking_news === 1 ? 'checked' : '' }} value="1"
                                        data-id="{{ $news->id }}" data-name="is_breaking_news" type="checkbox"
                                        name="is_breaking_news" class="custom-switch-input toggle-status">
                                    <span class="custom-switch-indicator"></span>
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <label class="custom-switch mt-2">
                                    <input {{ $news->show_at_slider === 1 ? 'checked' : '' }} value="1"
                                        data-id="{{ $news->id }}" data-name="show_at_slider" type="checkbox"
                                        name="show_at_slider" class="custom-switch-input toggle-status">
                                    <span class="custom-switch-indicator"></span>
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <label class="custom-switch mt-2">
                                    <input {{ $news->show_at_popular === 1 ? 'checked' : '' }} value="1"
                                        data-id="{{ $news->id }}" data-name="show_at_popular" type="checkbox"
                                        name="show_at_popular" class="custom-switch-input toggle-status">
                                    <span class="custom-switch-indicator"></span>
                                </label>
                            </div>
